...
export default function Doctrines() {
  ...
  return (
    ...
    <div className="flex flex-col justify-center">
        ...
        <div className="flex justify-center items-center bg-[url('../public/bible-wood.jpg')] bg-cover bg-position-[center_top_40rem] h-75">
            <h1 className="text-white text-7xl text-shadow-md text-shadow-zinc-900 font-noto-sans">
                Our Beliefs
            </h1>
        </div>


        <div className="flex flex-col gap-15 text-left pt-20 pl-40 pr-120 pb-30 font-noto-sans">

            <div>
                <h1 className="text-4xl tracking-wide pb-5">REPENTANCE</h1>
                     <p className="leading-8"><b>Repentance is a godly sorrow for sin with a renunciation of sin. (Isaiah 55:7; Matthew 4:17)</b> <br />
            ...
            <div>
                <h1 className="text-4xl tracking-wide pb-5">SALVATION</h1>
                <p className="leading-8"> <b>Salvation is the act of God's grace whereby we receive forgiveness for sins and stand before God as though we had never sinned. (Romans 5:1; 2 Corinthians 5:17) </b> <br />
             ...
             <div>
                <h1 className="text-4xl tracking-wide pb-5">SANCTIFICATION</h1>
                <p className="leading-8"> <b>Sanctification or Holiness, the act of God's grace whereby we are made holy, is the second definite work and is subsequent to salvation. (John 17:15-21; Hebrews 13:12)</b> <br />
            ...
            <div>
                <h1 className="text-4xl tracking-wide pb-5">THE BAPTISM OF THE HOLY GHOST</h1>
                <p className="leading-8"> <b>The Baptism of the Holy Ghost is the enduement of power from on high upon the clean, sanctified life, and is evidenced by speaking in tongues as the Spirit gives utterance. (Luke 24:49; Acts 1:5-8; 2:1-4)</b> <br />
            ...
            <div>
                <h1 className="text-4xl tracking-wide pb-5">THE SECOND COMING OF JESUS</h1>
                <p className="leading-8"> <b>The Second Coming of Jesus will be just as literal and visible as His going away. Acts 1:9-11. There will be two appearances under one coming: First, to catch away His waiting Bride. Matthew 24:40-44; 1 Thessalonians 4:15-17. Second, to execute judgment upon the ungodly. (2 Thessalonians 1:7-10; Jude 14-15)</b> <br />
            ...
            <div>
                <h1 className="text-4xl tracking-wide pb-5">The Great Tribulation</h1>
                <p className="leading-8"> <b>The Second Coming of Jesus will be just as literal and visible as His going away. Acts 1:9-11. There will be two appearances under one coming: First, to catch away His waiting Bride. Matthew 24:40-44; 1 Thessalonians 4:15-17. Second, to execute judgment upon the ungodly. (2 Thessalonians 1:7-10; Jude 14-15)</b> <br />
