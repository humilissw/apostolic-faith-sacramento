    ...
    <div className="flex justify-center bg-[url('../public/frontChurchCopy1.JPG')] h-screen bg-cover bg-center bg-fixed">
      <div className="">
        ...
        <div className="flex gap-8 pt-5 justify-center items-center">
          <Button className="border-2 border-white bg-transparent font-lora" variant="default">About Us</Button>
          <Button className="border-2 border-white bg-transparent font-lora" variant="default">Latest Sermon</Button>
        </div>
      </div>
    </div>
  )
