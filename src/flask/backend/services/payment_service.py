...
class PaymentService:
    ...
    def _resolve_stripe_key(self) -> str:
        ...
        assert self._session is not None, "PaymentService requires a session for credential resolution"
        ...
        if integration and integration.enabled and integration.cred_encrypted_blob:
            from backend.services.integration_service import EncryptionHelper
