...
def register_routes(app: Flask):
    ...
    from backend.api.routes.client_credentials import router as client_credentials_router
    from backend.api.routes.google import router as google_router
    from backend.api.routes.private import router as private_router
    from backend.api.routes.user_scopes import router as user_scopes_router
