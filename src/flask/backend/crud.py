...
from backend.models import Item, ItemCreate, Media, User, UserCreate, UserUpdate, VideoUpload
...
def create_video_upload(*, session, video_upload_in: VideoUploadCreate, owner_id: str) -> VideoUpload:
...
def update_video_upload(*, session, db_video_upload: VideoUpload, video_upload_in: VideoUploadUpdate) -> VideoUpload:
