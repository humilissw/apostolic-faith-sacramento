...
describe('loginForm Form ', () => {
  ...
  it('should display password minimum length error when password is too short', async () => {
    const { user } = setup(<LoginForm />);
    ...
    expect(await screen.findByText(/Password must be at least 6 characters/i)).toBeOnTheScreen();
  });

  it('should not display validation errors when form is valid', async () => {
    const { user } = setup(<LoginForm />);
