...
- Name: doctrines.spec.ts >> Doctrines page >> renders accordion with belief topics
- Location: tests/doctrines.spec.ts:12:2
...
Locator: getByRole('button', { name: /the divine trinity/i })
Expected: visible
Error: element(s) not found

Call log:
  - Expect "to.be.visible" with timeout 10000ms
  - waiting for getByRole('button', { name: /the divine trinity/i })
