...
- Name: contact.spec.ts >> Contact page >> renders email links
- Location: tests/contact.spec.ts:25:2
...
Locator: getByRole('link', { name: 'pete@sferle.com' }).first()
Expected: visible
Error: element(s) not found

Call log:
  - Expect "to.be.visible" with timeout 10000ms
  - waiting for getByRole('link', { name: 'pete@sferle.com' }).first()
