...
- Name: doctrines.spec.ts >> Doctrines page >> accordion items are collapsible
- Location: tests/doctrines.spec.ts:26:2
...
Locator: getByRole('button', { name: /the divine trinity/i }).first()
Expected: visible
Error: element(s) not found

Call log:
  - Expect "to.be.visible" with timeout 10000ms
  - waiting for getByRole('button', { name: /the divine trinity/i }).first()
