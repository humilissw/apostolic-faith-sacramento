...
- Name: contact.spec.ts >> Contact page >> renders Contact heading
- Location: tests/contact.spec.ts:8:2
...
Locator: getByRole('heading', { name: 'Contact', exact: true }).first()
Expected: visible
Error: element(s) not found

Call log:
  - Expect "to.be.visible" with timeout 10000ms
  - waiting for getByRole('heading', { name: 'Contact', exact: true }).first()
